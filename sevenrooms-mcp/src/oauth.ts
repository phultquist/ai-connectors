 ...
 * `${SEVENROOMS_CONNECTOR_KEY}` shell expansion has nothing to expand from.
 *
...
function consentForm(p: URLSearchParams, client: ClientRecord, error?: string): string {
  ...
  return `
  <h1>Connect SevenRooms</h1>
  <p class="sub">${escape(client.client_name || "An application")} is requesting read-only access to your SevenRooms data.</p>
  ...
  <form method="POST" action="/authorize">
    ...
    <p class="hint">This was provided to you by AI Connectors. It is not your SevenRooms password.</p>
    <button type="submit">Connect</button>
  </form>
  <p class="foot">Read-only. This cannot create, edit, or delete anything in SevenRooms.</p>`;
}
...
<title>Connect SevenRooms</title><style>
