...
export const SERVER_INFO = { name: "sevenrooms", version: "1.0.0" };
  ...
  switch (method) {
    case "initialize": {
      ...
      return result(id, {
        ...
        instructions:
          "Read-only access to SevenRooms scheduling, labor, and sales data. " +
          "Call sevenrooms_whoami first if you do not know the company id, then " +
          "sevenrooms_list_locations, since most reports are per-location. " +
          "sevenrooms_executive_summary gives a one-call rollup across all locations.",
      });
    }
...
export const CORS_HEADERS: Record<string, string> = {
  ...
  "Access-Control-Allow-Headers":
    "Content-Type, Authorization, Mcp-Session-Id, MCP-Protocol-Version, X-SevenRooms-Token",
